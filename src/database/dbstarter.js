...
db.run('CREATE TABLE users(uid INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT, name TEXT, password TEXT)', () =>db.run('INSERT INTO users (email,name,password) VALUES ("gmail.com","bruh","123")'));
